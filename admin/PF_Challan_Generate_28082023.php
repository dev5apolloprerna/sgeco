...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Report</title>
    ...
    <body class="page-container-bg-solid page-boxed">
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>PF Challan Generate Report</span>
                            </li>
                        </ul>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of PF Challan Generate Report</span>
                                        </div>
                                    </div>
        ...
        <script>
                ...
                function PageLoadData(Page) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/AjaxPFChallanGenerateReport.php",
                        data: {action: 'ListUser', Page: Page, month: month,Year: Year},
                ...
                function PageNewLoadData(Page) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/AjaxNewPFChallanGenerateReport.php",
                        data: {action: 'ListUser', Page: Page, month: month,Year: Year},
                        success: function (msg) {
                            $('#loading').css("display", "none");
                            $("#NewPlaceUsersDataHere").html(msg);
                        },
                    });
                }
                // end of filter
                ...
                //     //var salarymasterId = $('#salarymasterId').val();
                //     var salarymasterId = month+'/'+Year;
                //     var strURL = "generatenewCompanyReportPDF.php?Company=" + Company + "&salarymasterId=" + salarymasterId;
                ...
                function exporttoexcel()
                {
                    ...
                    //var salarymasterId = month+'/'+Year;
                    //var salarymasterId = $('#salarymasterId').val();
                    var strURL = "exportPFChallanGenerateReport.php?month=" + month + "&Year=" + Year;
                    //var strURL = "exportNewESICGenerateReport.php?Company=" + Company + "&salarymasterId=" + salarymasterId;
                    window.open(strURL, '_blank');
                }
