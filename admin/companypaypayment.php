...
<!--                                                        <input type="text"  id="salaryId"  name="salaryId" class="form-control date-picker" placeholder="Enter the Company UnSkil" required>-->
        ...
        <script>
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>admin/Ajaxcompanypaypayment.php",
            ...
            function checkb4submit()
            {
                ...
                //var salaryId = $('#salarymasterId').val();
                var salaryId = month+'/'+Year;
                var strURL = "generatecompanypaypaymentPDF.php?bank=" + bank + "&Company=" + Company + "&salaryId=" + salaryId;
            ...
            function exportToExcel()
            {
                ...
                var salaryId = month+'/'+Year;
                //alert(salaryId);
                var strURL = "generatecompanypaypaymentExcel.php?bank=" + bank + "&Company=" + Company + "&salaryId=" + salaryId;
                window.open(strURL, '_blank');
            }
        </script>
    </body>
