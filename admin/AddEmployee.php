    ...
    <body class="page-container-bg-solid page-boxed">
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="form-group col-md-3">
                                                        <input type="text" value="" name="Search_Aadhar" class="form-control" id="Search_Aadhar"  placeholder="Search Employee Aadhar" required/>
                                                    </div>
                                                    <div class="form-actions  col-md-3">
                                                        <a href="#" class="btn blue pull-left" id="clickbutton" onclick="getData(1);">Search</a>
                                                    </div>
                                                </div>
                                            </form>
                                            <hr />
                                                ...
                                                <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input name="strEmergencyContactNo" id="strEmergencyContactNo"  class="form-control" placeholder="Enter Your Emergency Contact No." pattern="[0-9]{10}" maxlength="10" minlength="10" type="text">
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="form_control_1">Qualification</label>
                                                            <input name="strQualification" id="strQualification"  class="form-control" placeholder="Enter Your Qualification" type="text"  >
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="form_control_1">Experience</label>
                                                            <input name="strExperience" id="strExperience"  class="form-control" placeholder="Enter Your Experience" type="text"  >
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4" style="display:none" id="divMarriedDate">
                                                            ...
                                                            <input name="strMarriedDate" id="strMarriedDate" class="form-control" placeholder="Enter Married Date" type="text" >
                                                        </div> 
                                                         
                                                        <div class="form-group col-md-4" style="display:none" id="divSon">
                                                            <label for="form_control_1">Son</label>
                                                            <input name="iSon" id="iSon" class="form-control" placeholder="Enter Number of Son" type="text" >
                                                        </div>
                                                        
                                                        <div class="form-group col-md-4" style="display:none" id="divDoughter">
                                                            <label for="form_control_1">Doughter</label>
                                                            <input name="iDoughter" id="iDoughter" class="form-control" placeholder="Enter Number of Doughter" type="text" >
                                                        </div>
        ...
        <script type="text/javascript">
            ...
            function getData() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>admin/getEmployeeData.php",
                    data: {action: 'ListUser', Search_Aadhar: Search_Aadhar},
                    success: function (msg) {
                        ...
                        $("#emp_name").val(json.emp_name);
                        $("#strFatherName").val(json.strFatherName);
                        $("#designation").val(json.designation);
                        $("#ecsno").val(json.ecsno);
                        $("#uan").val(json.uan);
                        $("#dateofbirth").val(json.dateofbirth);
                        //$("#dateofjoining").val(json.dateofjoining);
                        $("#bankid").val(json.bankid);
                        $("#accountno").val(json.accountno);
                        $("#ifsccode").val(json.ifsccode);
                        $("#mno").val(json.mno);
                        $("#strMaritalStatus").val(json.strMaritalStatus);
                        $("#strNomineeName").val(json.strNomineeName);
                        
                        $("#strNomineeRelation").val(json.strNomineeRelation);
                        $("#strNomineeAdharNo").val(json.strNomineeAdharNo);
                        $("#address").val(json.address);
                        $("#strPermanentAddress").val(json.strPermanentAddress);
                        $("#aadharcard").val(json.adharcard);
                        $("#pancard").val(json.pancard);
                        
                        $("#strEmergencyContactNo").val(json.strEmergencyContactNo);
                        $("#strQualification").val(json.strQualification);
                        $("#strExperience").val(json.strExperience);
                        $("#strMarriedDate").val(json.strMarriedDate);
                        $("#iSon").val(json.iSon);
                        $("#iDoughter").val(json.iDoughter);
