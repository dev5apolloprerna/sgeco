                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Report</span>
                                        </div>
                                    </div>
        ...
        <script>
                                                        ...
                                                        function PageLoadData(Page) {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                data: {action: 'ListUser', Page: Page, Company: Company, salarymasterId: salarymasterId},
                                                        ...
                                                        function exporttoexcel()
                                                        {
                                                            ...
                                                            var salarymasterId = month+'/'+Year;
                                                            //var salarymasterId = $('#salarymasterId').val();
                                                            var strURL = "exportnewcompanyreport.php?Company=" + Company + "&salarymasterId=" + salarymasterId;
                                                            //var strURL = "generateBankRepotExcel_test.php?Company=" + Company + "&salarymasterId=" + salarymasterId;
                                                            window.open(strURL, '_blank');
                                                        }
