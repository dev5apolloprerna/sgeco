...
?>
        ...
        <table class="table table-bordered table-hover center table-responsive" width="100%" id="tableC">
            ...
            <tbody>
                ...
                $salaryDeductions = getMultiCompanyReportDeductions($dbconn, $salarymaster['companysalarymasterId']);
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    $advanceAmount = getEmployeeCompanyReportAdvance($salaryAdvances, $rowfilter['employeeId']);
                    $employeeDeductions = getEmployeeMultiCompanyReportDeductions($salaryDeductions, $rowfilter['employeeId']);
                    $pfAmount = $salarymaster['DeductPF'] == 'YES' ? $employeeDeductions['pf'] : 0;
                    $esicAmount = $salarymaster['DeductESIC'] == 'YES' ? $employeeDeductions['esic'] : 0;
                ...
                ?>
                        ...
                        <td><input type="number" min="0" <?php echo $advanceAmount > 0 ? 'max="' . htmlspecialchars(number_format($advanceAmount, 2, '.', ''), ENT_QUOTES, 'UTF-8') . '"' : ''; ?> step="0.01" class="form-control" value="<?php echo htmlspecialchars(number_format($advanceAmount, 2, '.', ''), ENT_QUOTES, 'UTF-8'); ?>" <?= $rowfilter['isExitEmployee'] == 1 ? 'readonly' : ""; ?> name="advance_paid_by_bank_<?php echo $rowfilter['employeeId'] ?>" id="advance_paid_by_bank_<?php echo $rowfilter['employeeId'] ?>" /></td>
                        <td><input type="text" class="form-control" value="<?php echo htmlspecialchars(number_format($pfAmount, 2, '.', ''), ENT_QUOTES, 'UTF-8'); ?>" readonly name="pf_amount_<?php echo $rowfilter['employeeId'] ?>" id="pf_amount_<?php echo $rowfilter['employeeId'] ?>" /></td>
                        <td><input type="text" class="form-control" value="<?php echo htmlspecialchars(number_format($esicAmount, 2, '.', ''), ENT_QUOTES, 'UTF-8'); ?>" readonly name="esic_amount_<?php echo $rowfilter['employeeId'] ?>" id="esic_amount_<?php echo $rowfilter['employeeId'] ?>" /></td>
                        <td>
