...
if ($_POST['action'] == 'ListUser') {
    ...
    if ($_REQUEST['token'] != NULL && $_REQUEST['token'] != NULL) {
        $where .= " and paymentMaster.iPaymentId = " . $_POST['token']. " ";
    }
    ...
    $countstr = "SELECT count(*) as TotalRow from paymentMaster 
                    inner join multicompany on paymentMaster.iPaymentId=multicompany.iPaymentId join employee on employee.employeeId=multicompany.emp_id " . $where . " and paymentMaster.isDelete=0 and paymentMaster.iStatus=1 ";
        ...
        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="tableC">
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                  ...
                  and salarymaster.month = '" . $rowfilter['salarymonth'] . "'  
                  and salarymaster.companymasterId in (select multiycompanysalarymaster.companymasterId from 
                  multiycompanysalarymaster where multiycompanysalarymaster.companysalarymasterId =  " . $rowfilter['iCompanySalaryMasterId'] . ")
                  and salarydetails.emp_id = " . $rowfilter['employeeId'] . "  and salarymaster.isDelete=0 ";
                    ...
                    $Balance = $rowfilter['balance1'] - $empdata['PaidAmount'];
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group form-md-line-input "><?= $Balance ?>
                                </div>
                            </td>
                            <td>
