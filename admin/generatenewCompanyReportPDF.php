...
while ($rowapplication = mysqli_fetch_array($result)) {
    ...
    $mailFormat = str_replace("#Sr.No#", (($i)), $mailFormat);
    $mailFormat_main = str_replace("#wageMonth#", (($wageMonth)), $mailFormat_main);
    $mailFormat_main = str_replace("#wage#", (($wege['month'])), $mailFormat_main);

    $mailFormat_main = str_replace("#FromDate#", (($wege['fromdate'])), $mailFormat_main);
    $mailFormat_main = str_replace("#ToDate#", (($wege['todate'])), $mailFormat_main);
    
    $mailFormat_main = str_replace("#month#", ((date('M'))), $mailFormat_main);
    $mailFormat_main = str_replace("#Year#", ((date('Y'))), $mailFormat_main);
    $mailFormat_main = str_replace("#comname#", (($comp['companyname'])), $mailFormat_main);

    $mailFormat_main = str_replace("#HighlySkilled#", (((int)$comp['highlyskilled'])), $mailFormat_main);
    $mailFormat_main = str_replace("#Skilled#", (((int)$comp['skil'])), $mailFormat_main);
    $mailFormat_main = str_replace("#SemiSkilled#", (((int)$comp['semiskill'])), $mailFormat_main);
    $mailFormat_main = str_replace("#UnSkilled#", (((int)$comp['unskill'])), $mailFormat_main);

    $mailFormat = str_replace("#Category#", (($Category)), $mailFormat);
    $mailFormat = str_replace("#Name_of_workman#", (($desg['emp_name'])), $mailFormat);
    ...
    $mailFormat = str_replace("#DA#", ((($rowapplication['da'] != '0.00') ? (int)$rowapplication['da'] : '')), $mailFormat);
    $mailFormat = str_replace("#HRA#", ((($rowapplication['hra'] != '0.00') ? (int)$rowapplication['hra'] : '')), $mailFormat);
    $mailFormat = str_replace("#NationalHolidayPayment#", ((($rowapplication['national_holiday_payment'] != '0.00') ? (int)$rowapplication['national_holiday_payment'] : '')), $mailFormat);
    $mailFormat = str_replace("#iBonusAmt#", ((($rowapplication['iBonusAmt'] != '0.00') ? (int)$rowapplication['iBonusAmt'] : '')), $mailFormat);
    $mailFormat = str_replace("#iLeaveAmt#", ((($rowapplication['iLeaveAmt'] != '0.00') ? (int)$rowapplication['iLeaveAmt'] : '')), $mailFormat);
    ...
    $mailFormat = str_replace("#DateOfPayement#", (($rowapplication['strPaymentDate'])), $mailFormat);
...
$mailFormat_main = str_replace("#TotalHRA#", (((int)$Total[11])), $mailFormat_main);
$mailFormat_main = str_replace("#TotalNationalHolidayPayment#", (((int)$Total[12])), $mailFormat_main);
$mailFormat_main = str_replace("#TotalBonusAmt#", (((int)$Total[13])), $mailFormat_main);
