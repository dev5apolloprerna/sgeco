...
$sql1 = "SELECT * FROM `employee`  " . $where . " and isDelete='0'  and  istatus='1' and isExitEmployee=1  order by employeecode desc";
...
if (mysqli_num_rows($result1) > 0) {
    ...
    $filename = 'EmployeeExitReportDownloadExcel'.date('dmyHis') . '.xls';
