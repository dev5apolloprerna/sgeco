...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Multi Company Bank Report</title>
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Multi Company Bank Report</span>
                            </li>
                        </ul>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Multi Company  Bank Report</span>
                                        </div>
                                    </div>
                                        ...
                                        <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <?php
                                                    // $queryCom = "SELECT * FROM `bankmaster`  where isDelete='0' and bankmasterId < 4 and  istatus='1' order by  bankmasterId asc LIMIT 3";
    ...
    <script>
                                                    ...
                                                    function PageLoadData(Page) {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url: "<?php echo $web_url; ?>admin/ajaxmulticompanybankreport_BOB.php",
                                                    ...
                                                    function checkb4submit()
                                                    {
                                                        ...
                                                        //var salarymonthId = $('#salarymonthId').val();
                                                        var salarymonthId = month+'/'+Year;
                                                        var strURL = "generatemulticompanyBankRepot_BOB_PDF.php?bank=" + bank + "&companysalarymasterId=" + companysalarymasterId + "&salarymonthId=" + salarymonthId;
                                                    ...
                                                    function exportToExcel()
                                                    {
                                                        ...
                                                        //var salarymonthId = $('#salarymonthId').val();
                                                        var salarymonthId = month+'/'+Year;
                                                        var strURL = "generatemulticompanyBankRepot_BOB_Excel.php?bank=" + bank + "&companysalarymasterId=" + companysalarymasterId + "&salarymonthId=" + salarymonthId;
                                                        window.open(strURL, '_blank');
                                                    }
