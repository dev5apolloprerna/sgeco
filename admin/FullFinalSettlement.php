                        ...
                        <div class="portlet-body form">
                            <form id="settlementSearch">
                                ...
                                <div class="settlement-actions">
                                    <button class="btn blue" type="submit"><i class="fa fa-search"></i> Preview Report</button>
                                    <!-- <button class="btn red" type="button" id="pdfButton"><i class="fa fa-file-pdf-o"></i> Download PDF</button> -->
                                    <button class="btn green" type="button" id="excelButton"><i class="fa fa-file-excel-o"></i> Download Excel</button>
                                    <button class="btn blue" type="button" id="wordButton"><i class="fa fa-file-word-o"></i> Download Word</button></div>
