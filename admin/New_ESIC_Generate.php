    ...
    <body class="page-container-bg-solid page-boxed">
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>New ESIC Generate Report</span>
                            </li>
                        </ul>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of New ESIC Generate Report</span>
                                        </div>
                                    </div>
        ...
        <script>
                ...
                function PageLoadData(Page) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/AjaxNewESICGenerateReport.php",
                ...
                function exporttoexcel()
                {
                    ...
                    //var salarymasterId = month+'/'+Year;
                    //var salarymasterId = $('#salarymasterId').val();
                    var strURL = "exportNewESICGenerateReport.php?month=" + month + "&Year=" + Year;
