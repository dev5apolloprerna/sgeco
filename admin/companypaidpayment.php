...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Bank Report</title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Bank Report</span>
                                        </div>
                                    </div>
...
<!--                                                        <input type="text"  id="salaryId"  name="salaryId" class="form-control date-picker" placeholder="Enter the Company UnSkil" required>-->
        ...
        <script>
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>admin/Ajaxcompanypaidpayment.php",
            ...
            function checkb4submit()
            {
                ...
                //var salaryId = $('#salarymasterId').val();
                var salaryId = month+'/'+Year;
                var strURL = "generatecompanypaidpaymentPDF.php?bank=" + bank + "&Company=" + Company + "&salaryId=" + salaryId;
            ...
            function exportToExcel()
            {
                ...
                var salaryId = month+'/'+Year;
                //alert(salaryId);
                var strURL = "generatecompanypaidpaymentExcel.php?bank=" + bank + "&Company=" + Company + "&salaryId=" + salaryId;
                window.open(strURL, '_blank');
            }
            
            function deletedata(task, iPaymentId,salarydetailsId,netamountpaid)
            {
                var errMsg = '';
                if (task == 'Delete') {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/Ajaxcompanypaidpayment.php",
                        data: {action: task, iPaymentId: iPaymentId,salarydetailsId: salarydetailsId,netamountpaid: netamountpaid},
                        success: function (msg) {
                            console.log(msg);
                            $('#loading').css("display", "none");
                            //window.location.href = 'companypaidpayment.php';
                            PageLoadData(1);
                            //return false;
                        },
                    });
