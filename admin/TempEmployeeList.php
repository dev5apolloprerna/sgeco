...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Temp Employee </title>
                                ...
                                <div class="portlet light " style="width: 100%;float: left;">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Temp Employee</span>
                                        </div>
                                        <a href="<?php echo $web_url; ?>admin/AddTempEmployee.php" class="btn blue" style="float: right;" title="Add Employee">ADD Temp Employee</a>
                                    </div>
                                    <div class="portlet-body form">

                                        <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                            <div class="form-group col-md-2">
                                                <input type="text" value="" name="Search_From_Date" class="form-control" id="Search_From_Date" placeholder="Enter From Date"/>
                                            </div>
                                            <div class="form-group col-md-2">
                                                <input type="text" value="" name="Search_To_Date" class="form-control" id="Search_To_Date" placeholder="Enter To Date"/>
                                            </div>
                                            <div class="form-group col-md-2">
                                                <input type="text" value="" name="Search_Txt" class="form-control" id="Search_Txt" placeholder="Search Temp Employee Name " onkeyup="PageLoadData(1);" required/>
                                            </div>
                                            <div class="form-group col-md-2">
                                                <input type="text" value="" name="Search_Aadhar" class="form-control" id="Search_Aadhar" placeholder="Search Temp Employee Aadhar" onkeyup="PageLoadData(1);" required/>
                                            </div>
    ...
    <script type="text/javascript">
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>admin/AjaxTempEmployee.php",
