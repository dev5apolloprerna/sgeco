...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Company Salary</title>
    ...
    <body class="page-container-bg-solid page-boxed">
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase" id="editCompanySalary">Add Company Salary</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="AddCompanySalary" name="action" id="action">
                                                <div class="form-body">
                                ...
                                <div class="col-md-8">
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                <i class="icon-settings font-red-sunglo"></i>
                                                <span class="caption-subject bold uppercase">List of Company Salary</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
        ...
        <style>
            .multiselect
            {
                ...
                border: 1px solid #f2686c  !important;
                border-radius: 4px;
                /*color: #e31e24;*/
                font-size: 15px;
...
//                                                            }
                                                            function deletedata(task, id)
                                                            {
                                                                ...
                                                                if (confirm(errMsg)) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "<?php echo $web_url; ?>admin/Ajaxcompanysalarymaster.php",
