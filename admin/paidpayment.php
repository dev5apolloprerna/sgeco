...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Paid Payment List</title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Paid Payment</span>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>admin/AjaxPaidpayment.php",
        ...
        function checkb4submit()
        {
            ...
            //var salarymonthId = $('#salarymonthId').val();
            var salarymonthId = month+'/'+Year;
            var strURL = "generatePaidpaymentRepotPDF.php?bank=" + bank + "&companysalarymasterId=" + companysalarymasterId + "&salarymonthId=" + salarymonthId;
        ...
        function exportToExcel()
        {
            ...
            //var salarymonthId = $('#salarymonthId').val();
            var salarymonthId = month+'/'+Year;
            var strURL = "generatePaidpaymentRepotExcel.php?bank=" + bank + "&companysalarymasterId=" + companysalarymasterId + "&salarymonthId=" + salarymonthId;
            window.open(strURL, '_blank');
        }

        function deletedata(task, iPaymentId,multicompanyid,Balance)
        {
            var errMsg = '';
            if (task == 'Delete') {
            ...
            if (confirm(errMsg)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>admin/AjaxPaidpayment.php",
                    data: {action: task, iPaymentId: iPaymentId,multicompanyid: multicompanyid,Balance: Balance},
                    success: function (msg) {
                        console.log(msg);
                        $('#loading').css("display", "none");
                        //window.location.href = 'paidpayment.php';
                        PageLoadData(1);
                        //return false;
                    },
                });
