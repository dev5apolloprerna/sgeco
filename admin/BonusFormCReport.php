...
function renderBonusFormCHtml(array $employees, $salaryMonth, $companyName)
{
    ...
    $html = '<html><head><meta charset="UTF-8"><style>' . $css . '</style></head><body><table class="head"><tr>' .
        ...
        '<table class="main"><colgroup><col style="width:1.5%"><col style="width:16.5%"><col style="width:16%"><col style="width:6.5%"><col style="width:5.5%"><col style="width:4%"><col style="width:4.5%"><col style="width:6.5%"><col style="width:6.5%"><col style="width:5.5%"><col style="width:5.5%"><col style="width:5.5%"><col style="width:6%"><col style="width:4.5%"><col style="width:5.5%"></colgroup><tr><th width="1.5%" rowspan="2">Sr.<br>No.</th><th width="16.5%" rowspan="2">Name of Workmen</th><th width="16%" rowspan="2">Father Name</th><th width="6.5%" rowspan="2">Whether he has Completed 15 years of age at the beginning of the accounting year</th><th width="5.5%" rowspan="2">Designation/ Nature of Work</th><th width="4%" rowspan="2">No. of days Worked</th><th width="4.5%" rowspan="2">Daily Rate</th><th width="6.5%" rowspan="2">Total salary or wage in respect of the accounting year</th><th width="6.5%" rowspan="2">Amount of Bonus Payable under section 10/11 as the case may be</th><th width="16.5%" colspan="3">Deduction</th><th width="6%" rowspan="2">Actually Amount Paid</th><th width="4.5%" rowspan="2">Date of Payment</th><th width="5.5%" rowspan="2">Signature / Thumb impression of workmen</th></tr><tr><th width="5.5%">Puja or other customary bonus paid during the accounting year</th><th width="5.5%">Interim bonus or bonus paid in advance</th><th width="5.5%">Amount of income tax deducted 10-A</th></tr>' .
