...
if (mysqli_num_rows($filterstr) > 0) {
    ...
    if ($_REQUEST['bank'] == 3 || $_REQUEST['bank'] == "") {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            $spreadsheet->getActiveSheet()->getStyle('A5:C5')->getFont()->setSize(10);
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            $spreadsheet->setActiveSheetIndex(0)
            ->setCellValue('A2', 'SUB :'.'PAYMENT SHEET')
            ->setCellValue('A3', 'SITE :'.$comp['companyname'])
            ->setCellValue('A4', 'Month : '.$formattedDate . ' - '. $bankname . '- Bank Payment');
            //date('M-y',strtotime(date('d-m-Y',strtotime($_REQUEST['salaryId']))))
