...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | View Multicompany Paypayment Employee List </title>
    ...
    <body class="page-container-bg-solid page-boxed">
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>View Multicompany Paypayment Employee List</span>
                            </li>
                        </ul>
                                ...
                                <div class="portlet light " style="width: 100%;float: left;">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Multicompany Paypayment Employee</span>
                                        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="tableC">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?= $data['iPaymentMode'] == 1 ? 'Cash' : 'Bank'; ?></td>
                                                <td><?= $data['bankName'] ?></td>
        ...
        <script type="text/javascript">
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>admin/AjaxViewMultiCompanyPaypaymentHistory.php",
        ...
        function checkb4submit()
        {
            ...
            var token = $('#token').val();
            var strURL = "generateViewMultiCompanyPaypaymentHistoryRepotPDF.php?token=" + token;
        ...
        {
            var token = $('#token').val();
            var strURL = "generateViewMultiCompanyPaypaymentHistoryExcel.php?token=" + token;
            window.open(strURL, '_blank');
        }
        </script>
