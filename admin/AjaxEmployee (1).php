...
if ($_POST['action'] == 'ListUser') {
    ...
    if (isset($_REQUEST['Search_UAN'])) {
        if ($_POST['Search_UAN'] != '') {
            $where.=" and  uan like '%" . $_POST['Search_UAN'] . "%' ";
        }
    }
    
    //and  istatus='1'
    $filterstr = "SELECT * FROM `employee`  " . $where . " and isDelete='0'  order by employeecode desc";
    $countstr = "SELECT count(*) as TotalRow FROM `employee`  " . $where . " and isDelete='0' ";
            ...
            <form name="frmparameter"  id="frmparameter" >
                <div class="row">
                    <div class="f_delet_btn">
                        ...
                        <!--<input type="hidden" value="employeeaddtoexportlist" name="action" id="action">-->
                        ...
                        <!--<button class="btn blue"> <a type="button" name="deletedata"  onclick="employeeaddtoexportlist();" value="View Export List">Export List </a> </button>-->
                    </div>
                    <!--<div class="f_delet_btn">-->
                ...
                <div class="table-responsive table-responsive-new">
                    ...
                    <tbody>
                        ...
                        while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                            if($rowfilter['isExitEmployee']==1 || $rowfilter['istatus']==0){
                        ?>
                        ...
                        ?>
                            ...
                            <?php } ?>
                                ...
                                <td style="width: 20%">
                                    <div class="form-group form-md-line-input">
                                        <a  class="btn blue" href="<?php echo $web_url; ?>admin/EditEmployee.php?token=<?php echo $rowfilter['employeeId']; ?>" title="Edit"><i class="fa fa-edit iconshowFirst"></i></a>
                                        ...
                                        <!--<a  class="btn blue" href="<?php echo $web_url; ?>admin/EmployeeLedger.php?token=<?php echo $rowfilter['employeeId']; ?>" title="Ledger"><i class="fa fa-user"></i></a>-->
                                        <!--<a  class="btn blue" href="<?php // echo $web_url;  ?>admin/addempcomskill.php?token=<?php // echo $rowfilter['employeeId'];  ?>" title="skill"><i class="fa fa-bars"></i></a>-->
                                        <a  class="btn blue" href="<?php echo $web_url; ?>admin/ViewDocument.php?token=<?php echo $rowfilter['employeeId']; ?>" title="View Document"><i class="fa fa-eye"></i></a>
                                        
                                        <?php if($rowfilter['istatus'] == 1){ ?>
                                            <a  class="btn blue" onClick="javascript: return deletedata('Block', '<?php echo $rowfilter['employeeId']; ?>');"   title="Block"><i class="fa fa-ban"></i></a>
                                        <?php } else { ?>
                                            <a  class="btn blue" onClick="javascript: return deletedata('Unblock', '<?php echo $rowfilter['employeeId']; ?>');"   title="Unblock"><i class="fa fa-unlock"></i></a>
                                        <?php } ?>
                                        ...
                                        <a  class="btn blue" target="_blank" href="<?php echo $web_url; ?>admin/EmployeeDetails.php?token=<?php echo $rowfilter['employeeId']; ?>" title="Employee Details"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                                        ...
                                        <?php if($rowfilter['isPermanent'] == 1){ ?>
                                            <a  class="btn blue" onClick="javascript: return isPermanentData('Remove', '<?php echo $rowfilter['employeeId']; ?>');"   title="Remove Permanent"><i class="fa fa-check"></i></a>
                                        <?php } else { ?>
                                            <a  class="btn blue" onClick="javascript: return isPermanentData('Add', '<?php echo $rowfilter['employeeId']; ?>');"   title="Add Permanent"><i class="fa fa-times"></i></a>
                                        <?php } ?>
                                    </div>
                                </td>
