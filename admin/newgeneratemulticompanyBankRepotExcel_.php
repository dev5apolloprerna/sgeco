...
//    echo "SELECT * FROM `bankmaster`  where isDelete='0'  and  istatus='1' and bankmasterId='" . $_REQUEST['bank'] . "'";
    ...
    if ($_REQUEST['bank'] == 3 || $_REQUEST['bank'] == "") {
         $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('A5', $BankName ." :" . $formattedDate .'- Bank Payment');
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ($Balance > 0) {
                ...
                $spreadsheet->getActiveSheet()
                    ...
                    ->setCellValueExplicit('E' . $rowNumber, str_replace('.','',str_replace('A/C','',str_replace('A/C. ','',$row['accountno']))), \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING)
                    ->setCellValue('F' . $rowNumber, '')
        ...
        $spreadsheet->getActiveSheet()->getColumnDimension('B')->setWidth(25); // Adjust the width as needed
