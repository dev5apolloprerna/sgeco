...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Exit Employee Report</title>
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Exit Employee Report</span>
                            </li>
                        </ul>
                                ...
                                <div class="portlet light " style="width: 100%;float: left;">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Exited Employee</span>
                                        </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form  role="form"  method="POST"  name="frmeditempbankdetail"  id="frmeditempbankdetail" enctype="multipart/form-data">
                    <input type="hidden" value="" name="iEmpId" id="iEmpId">
       ...
       <style>
        ...
        <script type="text/javascript">
            ...
            function checkb4submit()
            {
                ...
                var strURL = "employeeExitReporDownload.php?Search_Txt=" + Search_Txt+'&Search_Aadhar='+Search_Aadhar;
