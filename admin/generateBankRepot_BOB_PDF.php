...
while ($rowapplication = mysqli_fetch_array($result)) {
    ...
    $mailFormat = str_replace("#netamountpaid#", ucfirst(urldecode(ceil($rowapplication['netamountpaid']))), $mailFormat);
...
$mailFormat_main = str_replace("#netamounttotal#", ucfirst(urldecode($Total[1])), $mailFormat_main);
