                            ...
                            <div class="col-md-12">
                                <div class="portlet light " style="width: 100%;float: left;">
                                    <div class="portlet-title">
                                        ...
                                        <a class="btn blue" style="float: right;" href="javascript: history.go(-1)" id="backLink" title="Back" >Back</a>
                                        <!--<a href="<?php echo $web_url; ?>admin/ZipEmployeeDocument.php" class="btn blue" style="float: right;" title="Add Employee">ADD Employee</a>-->
                                    </div>
                                    <input type="hidden" name="iTempEmpId" id="iTempEmpId" value="<?php echo $_REQUEST['token']; ?>">
    ...
    <script type="text/javascript">
        function deletedata(task, id)
        {
            ...
            if (confirm(errMsg)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>admin/AjaxEmployeeTempDocument.php",
...
//            var Search_Txt = $('#Search_Txt').val();
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>admin/AjaxEmployeeTempDocument.php",
                data: {action: 'ListUser', Page: Page, iTempEmpId: iTempEmpId},
                success: function (msg) {
                    $('#loading').css("display", "none");
