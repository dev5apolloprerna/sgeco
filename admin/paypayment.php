...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Multicompany Pay Payment List</title>
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Multicompany Pay Payment List</span>
                            </li>
                        </ul>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Multicompany Pay Payment</span>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>admin/AjaxPaypayment.php",
        ...
        function exportToExcel()
        {
            ...
            //var salarymonthId = $('#salarymonthId').val(); 
            var salarymonthId = month+'/'+Year;
            var strURL = "generatePaypaymentRepotExcel.php?bank=" + bank + "&companysalarymasterId=" + companysalarymasterId + "&salarymonthId=" + salarymonthId;
            window.open(strURL, '_blank');
        }
