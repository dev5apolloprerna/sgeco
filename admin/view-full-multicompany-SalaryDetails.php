    ...
    <body class="page-container-bg-solid page-boxed">
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <a  class="margin_fr_25 btn blue pull-right"  href="multicompanyreport.php">Back</a>               
                                         <a href="multicompany_full_pdf1.php?token=<?php echo $_REQUEST['token'];?>" target="_"  class="btn red pull-right margin-bottom-20"><i class="fa fa-file-pdf-o"></i> Download Full Report</a>
                                        <!--   <a style="margin: 0 0 0 26px;"   class="m-portlet__nav-link btn btn-success margin-bottom-20"><i class="fa fa-file-excel-o"></i>&nbsp; Export Excel</a> -->
                                    <input type="hidden" name="companysalarymasterId" id="companysalarymasterId" value="<?php echo $_REQUEST['token'];?>" >
                                    <div class="row">
                                        <div class="portlet-body form" style="width: 100%;float: left;">
        ...
        <script>
                                                        ...
                                                        function PageLoadData(Page) {
                                                            ...
                                                            $.ajax({
                                                                type: "POST",
                                                                url: "<?php echo $web_url; ?>admin/Ajax-full-viewmulticompanys-Salarydetails.php",
