...
function renderFullFinalSettlement(array $data)
{
    ...
    return '<!doctype html><html lang="gu"><head><meta charset="utf-8"><title>Full &amp; Final Settlement</title><style>' .
        '@page{size:A4;margin:10mm 12mm}*{box-sizing:border-box}body{margin:0;color:#111;font-family:freeserif,serif;font-size:12px;line-height:1.35}.page{width:100%;max-width:186mm;margin:auto}.page+.page{page-break-before:always}.title{text-align:center;font-size:22px;margin:0 0 7px}.info{width:100%;border-collapse:collapse;margin-bottom:5px}.info td{padding:2px}.label{width:25%}.value{text-decoration:underline}.date{margin:4px 0 7px}.date span.right{float:right;width:48%}.salary{text-align:center;margin:5px 0 8px}.box{border:1px solid #555;padding:3px 18px;margin:0 7px}table.main,table.other{width:100%;border-collapse:collapse;table-layout:fixed}.main td,.other td{border:1px solid #555;padding:4px 5px;height:24px}.header{text-align:center}.amount{text-align:right}.other-wrap{margin-top:10px}.words{margin-top:9px;border-bottom:1px solid #333;padding-bottom:4px}.ack{margin-top:10px;font-size:11.5px;text-align:justify;line-height:1.55}.signs{width:100%;margin-top:12px}.signs td{width:50%;vertical-align:bottom;border:0}.worker{text-align:center;padding-top:42px}.bottom{margin-top:10px}.month{float:right}@media screen{body{background:#eee;padding:18px}.page{background:#fff;min-height:277mm;padding:10mm 12mm;box-shadow:0 0 5px #aaa}}@media print{.page{max-width:none}}' .
