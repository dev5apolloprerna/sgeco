...
function fullFinalWitnessSignature()
{
...
function getFullFinalSettlement($dbconn, $employeeId, $companyId, $salaryMonth)
{
    ...
    return array(
        ...
        'net' => $net,
        'notice_pay' => 0,
        'other_bonus' => $row['iBonusAmt'],
        'other_total' => (float) $row['iBonusAmt']
    );
}
...
function renderFullFinalSettlement(array $data)
{
    ...
    $signature = fullFinalWitnessSignature();
    $signatureHtml = $signature === ''
        ? '<span class="blank-line signature-line"></span>'
        // The dimensions must be present on the element itself: Word's HTML
        // importer does not consistently honour max-width/max-height rules.
        : '<img class="signature-image" src="' . $signature . '" width="105" height="35" alt="Witness signature">';
    return '<!doctype html><html lang="gu"><head><meta charset="utf-8"><title>Full &amp; Final Settlement</title><style>' .
        '@page{size:A4;margin:10mm 12mm}*{box-sizing:border-box}body{margin:0;color:#111;font-family:freesans;font-size:14px;line-height:1.35}.page{width:100%;max-width:186mm;margin:auto;page-break-inside:avoid}.page-break{display:block;clear:both;height:0;page-break-before:always;mso-break-type:page-break}.title{text-align:center;font-size:22px;font-weight:bold;margin:0 0 7px}.info{width:100%;border-collapse:collapse;margin-bottom:5px}.info td{padding:2px}.label{width:25%}.value{font-weight:bold;text-decoration:underline}.blank-line{display:inline-block;width:130px;height:1em;border-bottom:1px solid #111;vertical-align:bottom}.dates{width:100%;border-collapse:collapse;table-layout:fixed;margin:4px 0 7px}.dates td{width:50%;padding:2px 18px 2px 0;white-space:nowrap}.dates td+td{padding-left:18px;padding-right:0}.date-value{display:inline-block;width:80px;min-width:80px;margin-left:6px;font-weight:bold;text-align:center;border-bottom:1px solid #111}.salary{text-align:center;margin:5px 0 8px}.box{border:1px solid #555;font-weight:bold;padding:3px 18px;margin:0 7px}table.main,table.other{width:100%;border-collapse:collapse;table-layout:fixed}.main td,.other td{border:1px solid #555;padding:4px 5px;height:24px}.header{text-align:center;font-weight:bold}.amount{text-align:right}.bold td,.net td{font-weight:bold}.other-wrap{margin-top:10px;font-weight:bold}.words{margin-top:9px;font-weight:bold;border-bottom:1px solid #333;padding-bottom:4px}.ack{margin-top:10px;font-size:13px;text-align:justify;line-height:1.55}.signs{width:100%;margin-top:12px;table-layout:fixed}.signs td{width:50%;vertical-align:bottom;border:0}.witness-title{font-weight:bold}.signature-image{display:inline-block;width:105px;height:42px;margin-left:8px;vertical-align:middle}.signature-line{width:105px;margin-left:8px}.worker{text-align:center;padding-top:42px;font-weight:bold}.bottom{margin-top:10px}.month{float:right}@media screen{body{background:#eee;padding:18px}.page{background:#fff;min-height:277mm;padding:10mm 12mm;box-shadow:0 0 5px #aaa}.page-break{height:18px}}@media print{.page{max-width:none}}' .
        '</style></head><body><div class="page"><div class="title">ફુલ એન્ડ ફાયનલ સેટલમેન્ટ</div>' .
        '<table class="info"><tr><td class="label">કોન્ટ્રકટરનું નામ :</td><td><span class="value-text">SHREE GANESH ENGINEERING CO.</span></td></tr>' .
        '<tr><td>કોન્ટ્રકટરનું સરનામું :</td><td><span class="value-text">FF-8 Devshruti Complex, Mithakhali, Ahmedabad – 380006.</span></td></tr>' .
        '<tr><td>કામદારનું નામ :</td><td><span class="value-text">' . $e($data['employee_name']) . '</span></td></tr>' .
        '<tr><td>કામદારનું સરનામું :</td><td><span class="value-text">' . $e($data['employee_address']) . '</span></td></tr></table>' .
        '<table class="dates"><tr><td>દાખલ થયાની તારીખ : _____________________ <span class="date-value">&nbsp;</span></td><td>છુટા થયાની તારીખ : _____________________<span class="date-value">&nbsp;</span></td></tr></table>' .
