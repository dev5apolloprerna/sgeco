...
$html .= '<th width="5%">Sr.<br>No.</th><th width="18%">Beneficiary Account<br>Number</th><th width="11%">Amount</th><th width="25%">Beneficiary Name</th><th width="19%">Beneficiary Address</th><th width="14%">IFSC Code</th><th width="8%">Comm.</th>';
$html .= '</tr></thead><tbody>';
...
while ($result && $row = mysqli_fetch_assoc($result)) {
    ...
    $html .= '<tr>';
    $html .= '<td width="5%" align="center">' . $serial . '</td>';
...
$html .= '<tr style="background-color:#ccc;font-weight:bold"><td colspan="2" align="center">Total Amt.</td><td align="right">' . number_format($total, 2) . '</td><td colspan="3"></td><td align="right">' . number_format($totalCommission, 2) . '</td></tr>';
$html .= '</tbody></table></td></tr>';
$html .= '<tr><td>&nbsp;</td></tr><tr><td><table width="100%" cellspacing="0" cellpadding="5" border="0">';
$html .= '<tr><td width="38%"><table width="100%" cellspacing="0" cellpadding="5" border="1"><tr><td>Amount</td><td align="right">' . number_format($total, 2) . '</td></tr><tr><td>Bank Comm.</td><td align="right">' . number_format($totalCommission, 2) . '</td></tr><tr style="font-weight:bold"><td>Total Amt.</td><td align="right">' . number_format($total + $totalCommission, 2) . '</td></tr></table></td><td width="62%" align="right"><strong>FOR, SHREE GANESH ENGINEERING CO.</strong><br><br><br>HITESH.K.SHAH (PARTNER)</td></tr>';
