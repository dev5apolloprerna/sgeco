...
$mailFormat_main = file_get_contents("newform_new.html");
$i = 1;
$mailFormat_rows = "";
while ($rowapplication = mysqli_fetch_array($result)) {
    ...
    $mailFormat = file_get_contents("newform_tr_new.html");
    ...
    $mailFormat_main = str_replace("#wageMonth#", ucfirst(urldecode($wageMonth)), $mailFormat_main);
    ...
    $mailFormat = str_replace("#Deduction_total#", ucfirst(urldecode($Deduction_total)), $mailFormat);
...
$mailFormat_main = str_replace("#total#", urldecode($Total[0]), $mailFormat_main);
...
$mailFormat_main = str_replace("#deductiontotal#", urldecode($deductiontotal[0]), $mailFormat_main);
$mailFormat_main = str_replace("#netamountpaid#", urldecode($Total[3]), $mailFormat_main);
...
$pdf->writeHTMLCell(0, 0, '', '', $mailFormat_main, 0, 1, 0, true, '', true);
ob_end_clean();
