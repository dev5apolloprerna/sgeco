...
$reportHistory = array("MultiCompanyPaymentHistory.php", "CompanyPaymentHistory.php", "EmployeePaymentHistory.php", "PFESICDeductionReport.php");
                            ...
                            if((isset($row['isPaymentHistoryMenu']) && $row['isPaymentHistoryMenu'] == 1) || $_SESSION['AdminType'] == 1){ ?> 
                                ...
                                <a href="#">Payment History</a>
                                 <ul class="dropdown-menu pull-left">
                                    ...
                                    ?>
                                    <li>
                                        <a href="<?php echo $web_url; ?>admin/EmployeePaymentHistory.php">Employee Payment History</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $web_url; ?>admin/PFESICDeductionReport.php">PF &amp; ESIC Deduction Report</a>
                                    </li>
                                </ul>
                           </li>
                            <?php 
