...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> |  Payment History</title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of  Payment History</span>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>admin/AjaxCompanyPaypaymentHistory.php",
            ...
            if (confirm(errMsg)) {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        $('#loading').css("display", "none");
                        window.location.href = 'CompanyPaymentHistory.php';
        ...
        function exportToExcel()
        {
            ...
            //var salarymonthId = $('#salarymonthId').val(); 
            var salarymonthId = month+'/'+Year;
            var strURL = "generateCompanyPaymentHistoryExcel.php?bank=" + bank + "&companysalarymasterId=" + companysalarymasterId + "&salarymonthId=" + salarymonthId;
            window.open(strURL, '_blank');
        }
