...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `companysalarymaster`  " . $where . " and isDelete='0'  and  istatus='1' order by companysalarymasterId desc";
    $countstr = "SELECT count(*) as TotalRow FROM `companysalarymaster` " . $where . " and isDelete='0' and  istatus='1' ";
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        ...
                        ?>
                        <td>
                            <div class="form-group form-md-line-input "><?php echo $companymasterId; ?> 
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="form-group form-md-line-input ">                                  
                                <a class="btn blue" href="<?php echo $web_url; ?>admin/edit-companysalarymaster.php?token=<?php echo $rowfilter['companysalarymasterId']; ?>"  title="Edit"><i class="fa fa-edit iconshowFirst"></i></a> 
                                <a  class="btn blue" onClick="javascript: return deletedata('Delete', '<?php echo $rowfilter['companysalarymasterId']; ?>');"   title="Delete"><i class="fa fa-trash-o iconshowFirst"></i></a>
                                <a  class="btn blue" href="<?php echo $web_url; ?>admin/Add-multicompany-SalaryDetails.php?token=<?php echo $rowfilter['companysalarymasterId']; ?>" title="ADD Salary Details"><i class="fa fa-plus iconshowFirst"></i></i></a>
                            </div>
                        </td>
                        <?php
                    }
...
if ($_REQUEST['action'] == 'Delete') {
    ...
    $dealer = $connect->updaterecord($dbconn, 'multiycompanysalarymaster', $multiCompany, $where);
