...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Bank </title>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase" id="editBank">Add Bank</span>
                                            </div>
                                        </div>
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  id="Bank"  name="Bank" class="form-control" placeholder="Enter the Bank Name" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="form_control_1">Bank City</label>
                                                        <input type="text"  id="City"  name="City" class="form-control" placeholder="Enter the Bank City" required>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                <i class="icon-settings font-red-sunglo"></i>
                                                <span class="caption-subject bold uppercase">List of Bank</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
        ...
        <script type="text/javascript">
            ...
            function setEditdata(id)
            {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        document.getElementById("editBank").innerHTML = "EDIT Bank";
                        $('#loading').css("display", "none");
                        var json = JSON.parse(response);
                        $('#Bank').val(json.bankname);
                        $('#City').val(json.City);
                        $('#action').val('Editbankname');
